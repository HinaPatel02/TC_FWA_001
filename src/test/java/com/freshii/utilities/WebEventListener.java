...
public class WebEventListener extends BaseClass implements AppiumWebDriverEventListener, ITestListener {
	...
	public void beforeNavigateTo(String url, WebDriver w_driver) {
		System.out.println("Before navigating to: '" + url + "'");
	}

	public void afterNavigateTo(String url, WebDriver w_driver) {
		System.out.println("Navigated to:'" + url + "'");
	}

	public void beforeChangeValueOf(WebElement element, WebDriver w_driver) {
		System.out.println("Value of the:" + element.toString() + " before any changes made");
	}

	public void afterChangeValueOf(WebElement element, WebDriver w_driver) {
